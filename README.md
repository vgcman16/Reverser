...
- `reverser pe-object-field-trace <pe> --root-offset <offset> --follow-offset <offset> --target-offset <offset>` traces simple local register paths from a large root field load to smaller child field accesses, useful when offsets such as `+0x38` are too common for global scans
