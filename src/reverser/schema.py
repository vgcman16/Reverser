    ...
    return {
        ...
        "properties": {
            ...
            "results": {
                ...
                "items": {
                    "type": "object",
                    "required": ["target_va", "target_rva", "hit_count", "unfiltered_hit_count", "calls"],
                    "properties": {
                        "target_va": {"type": "string"},
                        "target_rva": {"type": "string"},
                        "hit_count": {"type": "integer"},
                        "unfiltered_hit_count": {"type": "integer"},
        ...
        "properties": {
            ...
            "scan": {
                ...
                "required": [
                    ...
                    "deduped_constructor_install_count",
...
def get_pe_remapped_jump_tables_schema() -> dict[str, object]:
    return {
        "type": "object",
        "required": ["type", "target", "image_base", "scan", "ranges", "warnings"],
        "properties": {
            "type": {"const": "pe-remapped-jump-tables"},
            "target": {"type": "string"},
            "image_base": {"type": "string"},
            "scan": {"type": "object"},
            "ranges": {"type": "array", "items": {"type": "object"}},
...
def _iter_schema_registry_entries() -> tuple[dict[str, object], ...]:
    return (
        ...
        {
            "kind": "pe-remapped-jump-tables",
            "path": "/schema/pe-remapped-jump-tables",
            "description": "Stable JSON schema for PE byte-remapped jump-table scans.",
            "factory": get_pe_remapped_jump_tables_schema,
        },
        {
            "kind": "pe-imports",
